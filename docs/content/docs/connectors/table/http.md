...
| http.user.agent                                                        | optional | The User-Agent header value for HTTP lookup requests. Default value is `flink-http-connector`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| http.user.agent                           | optional | The User-Agent header value for HTTP sink requests. Default value is `flink-http-connector`.                                                                                                                                       |
