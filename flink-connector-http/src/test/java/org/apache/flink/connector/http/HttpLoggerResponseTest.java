...
public class HttpLoggerResponseTest {
    ...
    void testCreateStringForResponse(TestSpec testSpec) throws URISyntaxException {
    ...
    static Collection<TestSpec> configProvider() {
        return Stream.concat(getTestSpecs("GET", 200).stream(), getTestSpecs("POST", 500).stream())
        ...
        return List.of(
                ...
                new TestSpec(
                        ...
                        "HTTP "
                                + method
                                + " Response: URL: http://aaa, "
                                + "Response Headers: bbb:[ccc;ddd];eee:[fff], status code: "
                                + statusCode
                                + ", "
                                + "Response Body: None"),
                ...
                new TestSpec(
                        ...
                        "HTTP "
                                + method
                                + " Response: URL: http://aaa, Response Headers: ***"
                                + ", status code: "
                                + statusCode
                                + ", Response Body: ***"),
                new TestSpec(
